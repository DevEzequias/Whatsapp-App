...
import com.devezequias.whatsapp.fragment.ContatosFragment;
import com.devezequias.whatsapp.fragment.ConversasFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                //Verefica se esta pesquisando Conversas ou contatos
                ...
                switch (viewPager.getCurrentItem()){
                    case 0:
                        ...
                        if(newText != null && !newText.isEmpty()){
                            ...
                            conversasFragment.recarregarConversa();
                        }
                        break;
                    case 1:
