...
import com.devezequias.whatsapp.adapter.GrupoSelecionadoAdapter;
...
public class GrupoActivity extends AppCompatActivity {
    ...
    private RecyclerView recyclerMembrosSelecionados, recyclerMebros;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerMebros = findViewById(R.id.recyclerMembros);
        ...
        recyclerMebros.setLayoutManager(layoutManager);
        recyclerMebros.setHasFixedSize(true);
        recyclerMebros.setAdapter(contatosAdapter);

        recyclerMebros.addOnItemTouchListener(
