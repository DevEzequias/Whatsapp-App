...
import com.devezequias.whatsapp.helper.Permissao;
...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    private CircleImageView cicleImagemViewPerfil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cicleImagemViewPerfil = findViewById(R.id.cicleImageViewFotoPerfil);
        ...
        if(url != null){
            Glide.with(ConfiguracoesActivity.this)
                    .load(url)
                    .into(cicleImagemViewPerfil);
        }else {
            cicleImagemViewPerfil.setImageResource(R.drawable.padrao);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK){
            ...
            try {
                ...
                if (imagem != null){
                    cicleImagemViewPerfil.setImageBitmap(imagem);
